...
public class DateApp {
	...
	public void periodoEntreFechas(int version) {
		if(version==7) {
			...
			nacimiento.set(1996, 4, 23);
			actual.set(2022, 0, 13);
			...
			LocalDate nacimiento = LocalDate.of(1996, 5, 23);
			LocalDate actual = LocalDate.now();
			Period periodo = Period.between(nacimiento, actual);
			System.out.println("Han transcurrido "+ periodo.getYears()+ " años "+periodo.getMonths()+" meses "+periodo.getDays()+" dias, desde "
